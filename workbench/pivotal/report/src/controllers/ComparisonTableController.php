...
class ComparisonTableController extends BaseReportController {
    public function principal_page (UserInterface $teacher, CycleInterface $cycle, $mode = 1) {
        ...
        $data['report_subtitle'] = 'School Summary Grid Report';
    ...
    public function draw_comparison_table ($data) {
        ...
        $this->js_include('https://code.highcharts.com/modules/heatmap.js');
