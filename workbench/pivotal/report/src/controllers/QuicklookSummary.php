...
class QuicklookSummary extends BaseReportController {

    public function show_page(UserInterface $teacher, DepartmentInterface $department) {
        $limedata = new \LimeData();

        $school = School::find($department->school_id);

        //@todo refactor this and get rid of get_survey_ids $teacher->surveys->lists('sid');
