...
class UserController extends BaseUserController {
    ...
    public function login_as ($user_id) {
        ...
        if (Auth::user()->role != User::PIVOT_ADMIN) {
            ...
            if(Auth::user()->proxies->keyBy('id')->has($user_id))
            {
    ...
    public function index() {
        ...
        if ($email != '') {
            ...
            $users = User::whereIn('role', array(User::SCHOOL_ADMIN, User::PIVOT_ADMIN, User::CAMPUS_LEADER));
        }
    ...
    public function view(UserInterface $user) {
        ...
        $data['classes'] = $user->classesForYear();
    ...
    public function edit(UserInterface $user = null) {
        ...
        $roles = array(
            ...
            User::CAMPUS_LEADER => 'Campus leader',
