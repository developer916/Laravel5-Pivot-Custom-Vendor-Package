...
class SchoolsControllerBak extends BaseController {
    ...
    public function view(SchoolInterface $school) {
        ...
        return $this->get_view('school-view', $data)
    ...
    public function edit(SchoolInterface $school = null) {
        ...
        return $this->get_view('school-edit', $data);
    }
