...
class ImportCSVController extends BaseController
{
    ...
    public function process(School $school)
    {
    ...
    private function validate_file($school, $reader)
    {
        ...
        Validator::extend('useremailunique', function ($attribute, $reader, $params) {
            ...
            while ($row = $reader->next_row()) {
                ...
                } else if (User::get_by_email($row['email'])) {    // email collide with another school
                    return false;
                }
            }
            return true;
        ...
        Validator::extend('validrole', function ($attribute, $reader, $params) {
            $roles = array(User::SCHOOL_ADMIN, User::DEPARTMENT_HEAD, User::TEACHER);
